**PASCAL VOC 2012** (PASCAL visual object classes challenge 2012) is a dataset for instance segmentation, object detection, and semantic segmentation tasks. It is applicable or relevant across various domains.
